...
//        System.out.println ("p has new Content: " +((Content)p.getValue(handle)).getValue());
        ...
        System.out.println ("Persistent Object has new Content: " +((Content)handle.getPstValue(myPersistName, cClass)));   //?? new API
        c.setValue(c.getValue() + 1);
        handle.commit();
        System.out.println ("After commit:");
        System.out.println ("Persistent Object has new Content: " +((Content)handle.getPstValue(myPersistName, cClass)));
